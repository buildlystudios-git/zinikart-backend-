...
export interface Config {
  ...
  collections: {
    ...
    ratings: Rating;
    wishlists: Wishlist;
    'push-notification-logs': PushNotificationLog;
    forms: Form;
  ...
  collectionsSelect: {
    ...
    'push-notification-logs': PushNotificationLogsSelect<false> | PushNotificationLogsSelect<true>;
  ...
  jobs: {
    tasks: {
      ...
      sendFcm: TaskSendFcm;
      pruneTokens: TaskPruneTokens;
      writeNotificationLog: TaskWriteNotificationLog;
      inline: {
        input: unknown;
        output: unknown;
      };
    ...
    workflows: {
      dispatchPushNotification: WorkflowDispatchPushNotification;
    };
  };
  /**
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "push-notification-logs".
 */
...
export interface PayloadJob {
  ...
  log?:
    ...
    | null;
  workflowSlug?: 'dispatchPushNotification' | null;
  taskSlug?:
    | (
        | 'inline'
        | 'assignDeliveryPartner'
...
export interface PayloadLockedDocument {
  ...
  document?:
    ...
    | ({
        relationTo: 'push-notification-logs';
        value: string | PushNotificationLog;
      } | null)
    | ({
        relationTo: 'forms';
        value: string | Form;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "push-notification-logs_select".
 */
export interface PushNotificationLogsSelect<T extends boolean = true> {
  recipient?: T;
  title?: T;
  body?: T;
  data?: T;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "TaskSendFcm".
 */
export interface TaskSendFcm {
  input: {
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "TaskPruneTokens".
 */
export interface TaskPruneTokens {
  input: {
    recipientUserId: string;
    invalidTokens:
      | {
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "TaskWriteNotificationLog".
 */
export interface TaskWriteNotificationLog {
  input: {
    recipientUserId: string;
    templateKey: string;
    notificationTitle?: string | null;
  ...
  output: {
    success?: boolean | null;
    logCreated?: boolean | null;
    error?: string | null;
  };
}
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "WorkflowDispatchPushNotification".
 */
export interface WorkflowDispatchPushNotification {
  input: {
    recipientUserId: string;
    templateKey: string;
    templateData?:
