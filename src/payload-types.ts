...
export interface Config {
  ...
  jobs: {
    tasks: {
      ...
      processPayouts: TaskProcessPayouts;
      inline: {
        input: unknown;
        output: unknown;
      };
    ...
    workflows: {
      hourlyPayoutCheck: WorkflowHourlyPayoutCheck;
    };
  };
  /**
...
export interface Order {
  ...
  status:
    ...
    | 'cancelled';
  /**
   * Delivery fee charged to the customer for this order.
   */
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "payout-ledger".
 */
export interface PayoutLedger {
  id: string;
  order: string | Order;
  recipient: string | User;
  recipientType: 'retailer' | 'delivery_partner';
  retailerProfile?: (string | null) | Retailer;
  deliveryPartnerProfile?: (string | null) | DeliveryPartner;
  grossAmount: number;
  /**
  ...
  eligibleAt: string;
  paidAt?: string | null;
  status: 'pending' | 'eligible' | 'processing' | 'paid' | 'failed' | 'on_hold' | 'cancelled';
  /**
   * Razorpay payout ID or manual admin reference
   */
  payoutRef?: string | null;
  payoutInvoice?: (string | null) | PayoutInvoice;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "payout-invoices".
 */
export interface PayoutInvoice {
  id: string;
  invoiceNumber: string;
  invoiceType: 'retailer' | 'delivery_partner';
  recipient: string | User;
  retailerProfile?: (string | null) | Retailer;
  deliveryPartnerProfile?: (string | null) | DeliveryPartner;
  period: {
  ...
  totalNet: number;
  /**
   * Snapshot of recipient payment method at time of payout.
   */
  payoutDestination?: {
    methodType?: ('bank_account' | 'upi') | null;
    accountHolderName?: string | null;
    /**
  ...
  paidAt?: string | null;
  /**
   * Razorpay payout ID or manual reference
   */
  payoutRef?: string | null;
  adminNotes?: string | null;
  updatedAt: string;
...
export interface PayloadJob {
  ...
  log?:
    ...
    | null;
  workflowSlug?: 'hourlyPayoutCheck' | null;
  taskSlug?:
    | (
        | 'inline'
        | 'assignDeliveryPartner'
...
export interface PayloadLockedDocument {
  ...
  document?:
    ...
    | ({
        relationTo: 'payout-ledger';
        value: string | PayoutLedger;
      } | null)
    | ({
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "payout-ledger_select".
 */
export interface PayoutLedgerSelect<T extends boolean = true> {
  order?: T;
  recipient?: T;
  recipientType?: T;
  retailerProfile?: T;
  deliveryPartnerProfile?: T;
  grossAmount?: T;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "payout-invoices_select".
 */
export interface PayoutInvoicesSelect<T extends boolean = true> {
  invoiceNumber?: T;
  invoiceType?: T;
  recipient?: T;
  retailerProfile?: T;
...
export interface PlatformSetting {
  id: string;
  deliveryFeeMode: 'flat' | 'variable';
  /**
   * Used for flat fee mode, or as fallback for variable mode.
   */
  defaultDeliveryFee: number;
  platformFeeRetailer: number;
  platformFeeDP: number;
  /**
   * Number of days to hold funds before eligible for payout.
   */
  payoutDelayDays: number;
  /**
   * Cosmetic label for UI
   */
  payoutDelayLabel: 'immediate' | 'daily' | 'weekly' | 'biweekly' | 'monthly';
...
export interface PlatformSettingsSelect<T extends boolean = true> {
  ...
  platformFeeRetailer?: T;
  platformFeeDP?: T;
  payoutDelayDays?: T;
  payoutDelayLabel?: T;
  minPayoutAmountINR?: T;
  payoutMode?: T;
  razorpayXGroup?:
    | T
    | {
        razorpayXAccountNumber?: T;
        razorpayXKeyId?: T;
        razorpayXKeySecret?: T;
      };
  updatedAt?: T;
  createdAt?: T;
  globalType?: T;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "TaskProcessPayouts".
 */
export interface TaskProcessPayouts {
  input?: unknown;
  output?: unknown;
}
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "WorkflowHourlyPayoutCheck".
 */
export interface WorkflowHourlyPayoutCheck {
  input?: unknown;
}
/**
 * This interface was referenced by `Config`'s JSON-Schema
